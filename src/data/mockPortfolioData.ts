...
export const mockSites: Site[] = [
  // NA Region
  {
    ...
    status: 'Active',
    sqm: 5200,
    buildingCode: 'NA-HRN-001',
    buildingTypeName: 'Corporate HQ',
    unit: 'GO',
    generalManager: 'Michael Reynolds',
    siteLeadership: 'Sarah Mitchell',
    ...
    utilizationRate: 28,
    rentableArea: 5200,
    planonBuildingStatus: 'Operational',
    ...
    notificationDate: '2026-12-30',
    regulation: 'SOX Compliant',
    commentsLog: 'Q3 review scheduled',
    statusSummary: 'Performing within budget',
    isREFM: true,
    isTIR: true,
    isEHS: true,
  ...
  },
  {
    ...
    status: 'Under Review',
    sqm: 45,
    buildingCode: 'NA-DAL-002',
    buildingTypeName: 'Satellite Office',
    unit: 'BU',
    generalManager: 'Lisa Thompson',
    siteLeadership: 'Mark Davis',
    ...
    utilizationRate: 15,
    rentableArea: 45,
    planonBuildingStatus: 'Under Review',
    ...
    notificationDate: '2024-11-28',
    regulation: 'Standard',
    commentsLog: 'Lease renewal pending decision',
    statusSummary: 'Low utilization flagged',
    isREFM: true,
    isTIR: false,
    isEHS: true,
    isPhysicalSecurity: true,
  ...
  // ISR Region
  {
    ...
    status: 'Active',
    sqm: 45000,
    buildingCode: 'ISR-RAN-001',
    buildingTypeName: 'R&D Campus',
    unit: 'GO',
    generalManager: 'Yossi Levi',
    siteLeadership: 'Tal Cohen',
    ...
    notificationDate: '2029-12-31',
    regulation: 'ISO 27001',
    commentsLog: 'Major campus - strategic asset',
    statusSummary: 'Core R&D facility',
    isREFM: true,
    isTIR: true,
    isEHS: true,
    isPhysicalSecurity: true,
  ...
  },
  {
    ...
    status: 'Under Review',
    sqm: 35,
    buildingCode: 'ISR-TLV-002',
    buildingTypeName: 'Flex Space',
    unit: 'BU',
    generalManager: 'Avi Stern',
    siteLeadership: 'Maya Rosen',
    ...
    notificationDate: '2025-03-31',
    regulation: 'Standard',
    commentsLog: 'Early termination clause available',
    statusSummary: 'Candidate for closure',
    isREFM: true,
    isTIR: false,
    isEHS: true,
  ...
  // IND Region
  {
    ...
    status: 'Active',
    sqm: 32000,
    buildingCode: 'IND-PUN-001',
    buildingTypeName: 'Tech Campus',
    unit: 'GO',
    generalManager: 'Arun Kumar',
    siteLeadership: 'Deepa Nair',
    ...
    notificationDate: '2027-09-30',
    regulation: 'ISO 27001, SOC 2',
    commentsLog: 'Expansion planned for 2026',
    statusSummary: 'High performing delivery center',
    isREFM: true,
    isTIR: true,
    isEHS: true,
    isPhysicalSecurity: true,
  ...
  },
  {
    ...
    status: 'Active',
    sqm: 48,
    buildingCode: 'IND-BLR-002',
    buildingTypeName: 'Support Center',
    unit: 'BU',
    generalManager: 'Vikram Singh',
    siteLeadership: 'Anita Rao',
    ...
    regulation: 'Standard',
    commentsLog: 'Strategic location for support',
    statusSummary: 'Optimized operations',
    isREFM: true,
    isTIR: false,
    isEHS: true,
    isPhysicalSecurity: true,
  ...
  // EMEA Region
  {
    ...
    status: 'Active',
    sqm: 2800,
    buildingCode: 'EMEA-DUB-001',
    buildingTypeName: 'Regional Office',
    unit: 'GO',
    generalManager: 'Sean OBrien',
    siteLeadership: 'Fiona Kelly',
    ...
    notificationDate: '2028-08-31',
    regulation: 'GDPR, ISO 27001',
    commentsLog: 'Hybrid work policy impact',
    statusSummary: 'Optimization opportunity',
    isREFM: true,
    isTIR: true,
    isEHS: true,
    isPhysicalSecurity: true,
  ...
  },
  {
    ...
    status: 'Under Review',
    sqm: 28,
    buildingCode: 'EMEA-LON-002',
    buildingTypeName: 'Coworking',
    unit: 'BU',
    generalManager: 'James Wright',
    siteLeadership: 'Sophie Brown',
    ...
    regulation: 'Standard',
    commentsLog: 'Flexible lease - monthly termination',
    statusSummary: 'Recommended for closure',
    isREFM: true,
    isTIR: false,
    isEHS: false,
    isPhysicalSecurity: false,
  ...
  // APAC Region
  {
    ...
    status: 'Active',
    sqm: 1800,
    buildingCode: 'APAC-SYD-001',
    buildingTypeName: 'Regional HQ',
    unit: 'GO',
    generalManager: 'Robert Taylor',
    siteLeadership: 'Jennifer Wong',
    ...
    regulation: 'ISO 27001',
    commentsLog: 'Space consolidation planned',
    statusSummary: 'Cost optimization in progress',
    isREFM: true,
    isTIR: true,
    isEHS: true,
    isPhysicalSecurity: true,
  ...
  // CALA Region
  {
    ...
    status: 'Active',
    sqm: 2200,
    buildingCode: 'CALA-MEX-001',
    buildingTypeName: 'Regional Office',
    unit: 'GO',
    generalManager: 'Ricardo Gomez',
    siteLeadership: 'Maria Santos',
    ...
    notificationDate: '2029-06-30',
    regulation: 'Local compliance',
    commentsLog: 'Stable operations',
    statusSummary: 'Performing well',
    isREFM: true,
    isTIR: true,
    isEHS: true,
    isPhysicalSecurity: true,
